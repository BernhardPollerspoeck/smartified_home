...
namespace smart.database.Migrations
{
    ...
    [Migration("20221201190913_ImageData")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("smart.database.Image", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("smart.database.PlanDefinition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("smart.database.PlanElement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("smart.database.PlanDefinition", b =>
                {
                    b.HasOne("smart.database.Image", "Image")
                        .WithMany()
            ...
            modelBuilder.Entity("smart.database.PlanElement", b =>
                {
                    b.HasOne("smart.database.HomeElement", "Element")
                        .WithMany()
                    ...
                    b.HasOne("smart.database.PlanDefinition", "Plan")
                        .WithMany("Elements")
